...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/data/Run2017G/HighEGJet/MINIAOD/UL2017_MiniAODv2-v2/2530000/02656A14-96A9-A543-A55E-245173CA9920.root'),
...
process.HiForestInfo = cms.EDAnalyzer("HiForestInfo",
    GlobalTagLabel = cms.string('106X_dataRun2_v35'),
    HiForestVersion = cms.string(''),
    info = cms.vstring('HiForest, miniAOD, 106X, data')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('HiForestMiniAOD_up.root')
)
...
process.forest = cms.Path(process.HiForestInfo+process.hltanalysis+process.hiEvtAnalyzer+process.trackSequencePP+process.unpackedMuons+process.muonAnalyzer+process.recoJetSequence+process.rhoSequence+process.ak3PFJetAnalyzer, process.patAlgosToolsTask)
